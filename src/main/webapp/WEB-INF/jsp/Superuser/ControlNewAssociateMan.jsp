...
<html>
        ...
        <script>
            $(document).ready(function(){
                ...
                $("#backLink").click(function(){
                    $("#action").val("back");
                    $("#controlNewAssociateManForm").submit();
                });
    ...
    <body>
        <compress:compress>
            <html:form action="ControlNewAssociateMan.do" styleId="controlNewAssociateManForm">
                ...
                <center id="container">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="5">
                                    ...
                                    &nbsp;&nbsp;
                                    <button id="backBtn" onclick="return false">Cancel</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <logic:equal name="controlNewAssociateManForm" property="count" value="0" scope="request">
                        <h5>Search Results</h5>
                        None
                    </logic:equal>
                    <logic:greaterThan name="controlNewAssociateManForm" property="count" value="0" scope="request">
                        <h5>Search Results</h5>
                        <div id="searchResults">
                            Page <bean:write name="controlNewAssociateManForm" property="displayPageNum" scope="request"/> of <bean:write name="controlNewAssociateManForm" property="displayPageCount" scope="request"/>
                            <br>
                            Number of Results: <bean:write name="controlNewAssociateManForm" property="count" scope="request"/>
                            <br>
                            ...
                            <div class="tableContainer">
                                <table class="paulaQueryTable">
                                    ...
                                    <tbody>
                                        <logic:iterate id="person" name="controlNewAssociateManForm" property="queryResults" scope="request">
                                            <tr>
                                                <td>
