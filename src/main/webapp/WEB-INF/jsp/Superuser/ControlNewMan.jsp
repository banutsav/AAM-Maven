...
<html>
    ...
    <body>
        <compress:compress>
            <html:form action="ControlNewMan.do" styleId="controlNewManForm">
                ...
                <center id="container">
                    ...
                    <logic:equal name="controlNewManForm" property="count" value="0" scope="request">
                        <h5>Search Results</h5>
                        None
                    </logic:equal>
                    <logic:greaterThan name="controlNewManForm" property="count" value="0" scope="request">
                        <h5>Search Results</h5>
                        <div id="searchResults">
                            Page <bean:write name="controlNewManForm" property="displayPageNum" scope="request"/> of <bean:write name="controlNewManForm" property="displayPageCount" scope="request"/>
                            <br>
                            Number of Results: <bean:write name="controlNewManForm" property="count" scope="request"/>
                            <br>
                            ...
                            <div class="tableContainer">
                                <table class="paulaQueryTable">
                                    ...
                                    <tbody>
                                        <logic:iterate id="person" name="controlNewManForm" property="queryResults" scope="request">
                                            <tr>
                                                <td>
