...
<html>
    ...
    <body>
        <compress:compress>
            <html:form action="ControlAssociates.do" styleId="controlAssociatesForm">
                ...
                <center id="container">
                    ...
                    <h3>Activate/Deactivate Associate</h3>
                    <hr/>
                    ...
                    <logic:notEmpty name="controlAssociatesForm" property="executed" scope="session">
                        <logic:equal name="controlAssociatesForm" property="count" value="0" scope="session">
                            <h5>Search Results</h5>
                            None
                        </logic:equal> 
                        <logic:notEqual name="controlAssociatesForm" property="count" value="0" scope="session">
                            <h5>Search Results</h5>
                            <div id="searchResults">
                                Page <bean:write name="controlAssociatesForm" property="displayPageNum" scope="session"/> of <bean:write name="controlAssociatesForm" property="displayPageCount" scope="session"/>
                                <br>
                                Number of Results: <bean:write name="controlAssociatesForm" property="count" scope="session"/>
                                <br>                        
                                    ...
                                    <table class="paulaQueryTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Active</th>
                                                <th>MYID</th>
                                                <th>Login ID (Associate Email)</th>
                                                <th>UGAID</th>
                                                <th>Title</th>
                                        ...
                                        <tbody>
                                            <logic:iterate id="person" name="queryResults" scope="request">
                                                <tr>
                                                    ...
                                                    <td><bean:write name="person" property="EXPIRATION_DATE" scope="page"/></td>
