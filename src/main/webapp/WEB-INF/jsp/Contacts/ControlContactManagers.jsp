...
<html>
    <head>
        ...
        <script>
            ...
            function ManageAdmin(adminId){
                ...
                $("#controlContactManagersForm").submit();
            }
    ...
    <body>
        <compress:compress>
            <html:form action="ControlContactManagers.do" styleId="controlContactManagersForm">
                ...
                <center id="container">
                   ...
                   <logic:notEmpty name="errorMsg" scope="request">
                    ...
                    <div style="text-align: left;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="5">
                                        ...
                                        &nbsp;&nbsp;
                                        <button id="newManagerBtn" onclick="return false">Add New Manager</button>
                                    </td>
                                </tr>
                        ...
                        <logic:notEmpty name="controlContactManagersForm" property="executed" scope="session">
                            <logic:equal name="controlContactManagersForm" property="count" value="0" scope="session">
                                <h5>Search Results</h5>
                                None
                            </logic:equal> 
                            <logic:notEqual name="controlContactManagersForm" property="count" value="0" scope="session">
                                <h5>Search Results</h5>
                                <div id="searchResults">
                                    Page <bean:write name="controlContactManagersForm" property="displayPageNum" scope="session"/> of <bean:write name="controlContactManagersForm" property="displayPageCount" scope="session"/>
                                    <br>
                                    Number of Results: <bean:write name="controlContactManagersForm" property="count" scope="session"/>
                                    <br>                        
