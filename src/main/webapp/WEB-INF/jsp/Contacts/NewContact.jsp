...
<html>
        ...
        <script>
            ...
            $(document).ready(function(){
               $("#submitBtn").click(function(){
                    ...
                    $("#action").val("new");
                    $("#targPersonCannum").val(<bean:write name="newContactForm" property="targPersonCannum" scope="request"/>);
                    $("#myid").val("<bean:write name='newContactForm' property='myid' scope='request'/>");
    ...
    <body>
        <html:form action="NewContact.do" styleId="newContactForm">
            ...
            <html:hidden styleId="myid" property="myid"/>
            <center id="container">
                    ...
                    <div>
                        <div style="text-align: right;">
                            ...
                            <a href="./Get.do?action=ManCreateNewContact">Back</a>
                        </div>
                    </div> 
                    <bean:define id="contact" name="newContactForm" scope="request"/>
                    <div style="text-align: left;">
                        <table>
                            <tr><td><h5>Enter Contact Details</h5></td></tr>
                            <tr></tr>
                            ...
                            <%--<logic:notEqual name="contact" property="targPersonCannum" value="0" scope="page">
                            <tr><td>UGAID PRIME: </td>
                                <td>
                                <bean:write name="contact" property="targPersonCannum" scope="page"/>
                                </td>
                            </tr>
                            </logic:notEqual>--%>
                            ...
                            <%--<tr>
                                <td><b style="color: red;">*</b>Country: </td>
                                <td><html:text name="contact" property="country" maxlength="64" size="32" styleId="country"/></td>
                            </tr>--%>
