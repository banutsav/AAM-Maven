<%-- 
    Document   : ManCreateNewAff
    Created on : Mar 25, 2013, 1:28:43 PM
    Author     : submyers
--%>
...
<html>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                $("#submitBtn").click(function(){
                    if($("#firstName").val().toString() == "" || $("#lastName").val().toString() == ""){
                    ...
                    var purposeIds = "";
                    var purpose_periods = "";
                    //var purpose_period_counts = "";
                    $(".selected_purpose").each(function(){
                        if($(this).attr("refId")){
                            refId = $(this).attr("refId");
                            purposeIds += $(this).attr("refId") + " ";
                            //expiration_dates += $("#dateTime_" + $(this).attr("refId")).val() + ",";
                            purpose_periods += $("#purpose_period_" + refId).val() + " ";
                            //purpose_period_counts += $("#purpose_period_count_" + refId).val() + " ";
                        }
                    })
                    $("#purpose_ids").val(purposeIds);
                    $("#purpose_periods").val(purpose_periods);
                    //$("#purpose_period_counts").val(purpose_period_counts);
                    $("#state").val($("#state_selected").val());
                    $("#country").val($("#country_selected").val());
                    $("#action").val("submit");
                    
                    $("#manCreateNewAff").submit();
                });
    ...
    <body>
        ...
        <html:form styleId="manCreateNewAff" action="ManCreateNewAff.do">
            ...
            <html:hidden styleId="purpose_periods" property="purpose_periods"/>
            <!--html:hidden styleId="purpose_period_counts" property="purpose_period_counts"/-->
            <html:hidden styleId="state" property="state"/>
            <html:hidden styleId="country" property="country"/>
            <bean:define id="email" name="manCreateNewAffForm" property="email" scope="request" toScope="page" type="String"/>
            <html:hidden styleId="email" property="email" value="<%= email%>"/>
            <center id="container">
                    <%@include file="/WEB-INF/jspf/messages.jsp"%>

                    <h3>New Non-Provisional Affiliate</h3>
                    <hr/>
                ...
                <logic:empty name="manCreateNewAffForm" property="purposes" scope="request">
                    <br>
                    You don't have authority to manage any purpose.
                </logic:empty>
                <logic:notEmpty name="manCreateNewAffForm" property="purposes" scope="request">
                    <br>
                    Please fill out the following New Affiliate form.<br>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>First Name</td>
                            <td><html:text size="32" maxlength="64" property="firstName" styleId="firstName"/></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>Middle Name</td>
                            <td><html:text size="32" maxlength="64" property="middleName" styleId="middleName"/></td>
                        </tr>
                        <tr>
                            <td><b style="color: red;">&bull;</b></td>
                            <td>Last Name</td>
                            <td><html:text size="32" maxlength="64" property="lastName" styleId="lastName"/></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>Email</td>
                            <td><bean:write name="manCreateNewAffForm" property="email" scope="request"/></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>Phone</td>
                        ...
                        <tr>
                            <td></td>
                            <td>Title</td>
                            <td><html:text styleId="title" size="32" maxlength="64" property="title" styleId="title"/></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>Business/Institution/Organization</td>
                            <td><html:text size="32" maxlength="64" property="organization" styleId="organization"/></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>Department</td>
                            <td><html:text size="32" maxlength="64" property="department" styleId="department"/></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>Address Line 1</td>
                            <td><html:text size="32" maxlength="64" property="addr1" styleId="addr1"/></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>Address Line 2 </td>
                            <td><html:text size="32" maxlength="64" property="addr2" styleId="addr2"/></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>City</td>
                            <td><html:text size="32" maxlength="64" property="city" styleId="city"/></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>State</td>
                            ...
                            <td>
                                <div id="selectedPurposeDiv" style="display: none;">
                                    <table>
                                        <thead>
                                            <tr>
                                                <th style="background-color: lightblue; padding: 0px 5px 0px 5px">
                                                    Purpose Name
                                                </th>
                                                <th style="background-color: lightblue; padding: 0px 5px 0px 5px">
                                                    Expiration Period
                                                ...
                                                <th>
                                                    <!--span style="color: #0000FF; cursor: pointer;" onclick='$("#help_dialog").dialog("open"); return false;'>help</span-->
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <logic:iterate id="purpose"  name="manCreateNewAffForm" property="purposes" scope="request">
                                                ...
                                                <tr id="selected_<bean:write name="purpose" property="ID" scope="page"/>" class="selected_purpose" style="display: none;">
                                                    <td>
                                                        <script>purposeTotal++;</script>
                                                        <bean:write name="purpose" property="SHORT_NAME" scope="page"/>  
                                                    </td>
                                                    <td>
                                                        <bean:define id="period" name="purpose" property="PERIOD" scope="page" toScope="page" type="String"/>
                                                        ...
                                                        <input type="hidden" id="purpose_period_<%= propId%>" value="<%= period%>">
                                                    </td>
                                                    <td>
                                                        <logic:equal name="purpose" property="PERIOD" scope="PAGE" value="-1">
                                                            Does not expire
                                                        ...
                                                        <logic:notEqual name="purpose" property="PERIOD" scope="PAGE" value="-1">
                                                            <bean:write name="purpose" property="DEFAULT_EXP_DATE" scope="page"/>
                                                        </logic:notEqual>
                                                    </td>
                                                    <td>
                    ...
                    <br>
                    <input type="button" id="submitBtn" onclick="return false;" value="Submit">
                    &nbsp;&nbsp;&nbsp;
            ...
            <div id="help_dialog" title="How to define expiration" style="display: none; font-size: 12px; text-align: center;">
                The user's expiration date for a purpose will be equal to<br>
                &nbsp;&nbsp;&nbsp;<b>(Current Date) + ((Period month(s)) * (Number of periods))</b><br>
                <input type="button" onclick="$('#help_dialog').dialog('close'); return false;" value="Close">
            </div>
        </html:form>
    </body>
</html>
