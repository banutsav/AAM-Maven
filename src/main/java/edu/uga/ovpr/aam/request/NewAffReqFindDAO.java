 ...
 * @author submyers
 */
public class NewAffReqFindDAO {

    public static void FindAff(NewAffReqFindForm newAffReqFindForm) throws Exception {
        ...
        try {
            ...
            final String findAffQuery = "SELECT DISTINCT"
                    ...
                    + " WHERE"
                    + " `a`.`OVPRID`='" + GeneralDAO.CleanMySQLString(newAffReqFindForm.getEmail()) + "'"
                    + " OR `a`.`EMAIL`='" + GeneralDAO.CleanMySQLString(newAffReqFindForm.getEmail()) + "'";
            ...
            if (findAffRs.next()) {
                ...
                newAffReqFindForm.setTargAffId(findAffRs.getString("ID"));
            }
            newAffReqFindForm.setResults(results);
        } catch (Exception ex) {
            throw ex;
        } finally {
            if (conn != null) {
    ...
    public static void AddPurposeReq(NewAffReqFindForm newAffReqFindForm) throws Exception {
        Connection conn = null;
        ...
        try {
            ...
            final String addPurposeCmd = "INSERT INTO"
                    ...
                    + " SET"
                    + " `AFFILIATE_ID`='" + newAffReqFindForm.getTargAffId() + "'"
                    + ", `AFFILIATE_PURPOSE_ID`='" + newAffReqFindForm.getTargPurpId() + "'"
                    + ", `CREATION_DATE`=NOW()";
